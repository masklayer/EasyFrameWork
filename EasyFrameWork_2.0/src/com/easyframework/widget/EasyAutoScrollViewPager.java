 ...
 * @author zhangbp
 */
public class EasyAutoScrollViewPager extends ViewPager {
	...
	private float touchX = 0f, downX = 0f, downY = 0f;
	private CustomDurationScroller scroller = null;

	public static final int SCROLL_WHAT = 0;

	public EasyAutoScrollViewPager(Context paramContext) {
		super(paramContext);
		init();
	}

	public EasyAutoScrollViewPager(Context paramContext, AttributeSet paramAttributeSet) {
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		if (slideBorderMode == SLIDE_BORDER_MODE_TO_PARENT || slideBorderMode == SLIDE_BORDER_MODE_CYCLE) {
			...
			if ((currentItem == 0 && downX <= touchX) || (currentItem == pageCount - 1 && downX >= touchX)) {
				if (slideBorderMode == SLIDE_BORDER_MODE_TO_PARENT || Math.abs(ev.getX() - downX) > Math.abs(ev.getY() - downY)) {
